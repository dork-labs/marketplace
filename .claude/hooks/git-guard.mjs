 ...
 *
 * Copied from the DorkOS app repo, where it was written. The incidents below
 * happened there; the shared-stash hazard applies to any repo with worktrees,
 * this one included.
 *
 ...
 * land another writer's stash on top of your tree. (In the DorkOS repo a Stop
 * hook also keeps auto-checkpoints there; this repo does not wire that hook.)
 *
 * WHAT IT BLOCKS
...
Both of those happened on 2026-07-22 in the DorkOS repo this guard came from.
