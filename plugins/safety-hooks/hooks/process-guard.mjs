 ...
 *
 * Written for the DorkOS app repo. On 2026-08-18 an agent there, tearing down
 ...
 * own node processes alive at once (dev servers, test runners and build
 * scripts are often all `node`), so any kill that matches on a NAME rather than a specific
