...
adapter applies that on write, together with the provenance signature, and that
includes Path C's promoted description and its reply to the reporter. Then report to the operator: identifier(s) with
