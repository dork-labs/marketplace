...
| `surface`    | Where this run was driven from: `dorkos` \| `bare-cli` \| `ci`. It decides which resume mechanism a later reader uses.                                                                                                                                                                                                                                                          |
