...
### 0.5 Claim the Item and Stamp the Run's Provenance

When this run works a tracker item that this session has not claimed yet, claim it (a person driving by hand adds `--manual`):
...
It moves the item to started with `agent/claimed` and no `stage/*` label, and records the run in `.dork/flow/flow-state.json` with a `provenance` block a later session finds its way back by, also **signed outward** (`<flow-root>/docs/provenance.md`). Exit 5 names what blocks the claim; exit 7 means paused. `flow claim` fills what it can derive; add `instanceId` and `resumeUrl` when you have them:

| Field        | What it is                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v`          | The schema version, `1`.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `harness`    | `claude-code` \| `codex` \| `opencode` \| `other:<name>`.                                                                                                                                                                                                                                                                                                                                                                                                   |
| `sessionId`  | This session's own id. Derive, never guess.                                                                                                                                                                                                                                                                                                                                                                                                                 |
| `account`    | A short, **non-PII** handle for the **harness** account (the runtime's own sign-in), **never the tracker account** (usually a real person). **Derive it, never guess**: for `claude-code`, the basename of `CLAUDE_CONFIG_DIR` (default `claude`); for `codex` and `opencode`, their own profile / home directory. If you cannot derive it, **omit it**. **Never an email address**: **if the value you derived contains an `@`, omit `account` entirely**. |
| `agentId`    | _(local only)_ The worker/agent id this run is operating as, when the harness assigns one.                                                                                                                                                                                                                                                                                                                                                                  |
| `host`       | This machine's hostname; a transcript is only reachable from its machine.                                                                                                                                                                                                                                                                                                                                                                                   |
