...
/**
 * The runtime (per `detectRuntime`) and that runtime's own session id.
 *
 * @param env - The environment.
 * @returns The runtime and session id, each `null` when unknown.
 */
export function runtimeSession(env: Readonly<Record<string, string | undefined>>): RuntimeSession {
